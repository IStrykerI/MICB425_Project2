...
**P2.** Analysis of similarities between the RNA abundance and the DNA abundance of norB with depth.

**P3.** Reconstructing the taxa associated with norB and Analyze variance based on depth, DNA, and RNA.
...
## Analysis of similarities between the RNA abundance and the DNA abundance of norB with depth \label{sec:OTUabundance}
...
## Reconstructing the taxa associated with norB and Analyze variance based on depth, DNA, and RNA \label{sec:richness}
